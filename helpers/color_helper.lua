...
function helper.random_color(a)
  local r = fmath.random_int(0,255)
  local g = fmath.random_int(0,255)
  local b = fmath.random_int(0,255)
  return helper.make_color(r,g,b,a)
end
